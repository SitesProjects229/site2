// Wexvorim i18n System - Auto language detection & switching
class I18n {
  constructor() {
    this.currentLang = 'en';
    this.translations = {};
  ...
  async init() {
    const savedLang = localStorage.getItem('Wexvorim_language');
  ...
  applyTranslations() {
    ...
    const brandHref = brandLink ? brandLink.href : 'https://Wexvorim.eu';
  ...
  async switchLanguage(lang) {
    ...
    localStorage.setItem('Wexvorim_language', lang);
